...
import {SiFigma, SiJavascript, SiNodedotjs, SiPhp, SiPython, SiReact, SiRedux, SiTypescript} from "react-icons/si";
...
export default function MainProject() {
  ...
  const ICONS = {
    ...
    javascript: <SiJavascript className="text-yellow-300 w-10 h-10" />,
      ...
      redux: <SiRedux className="text-purple-500 w-10 h-10" />
,
  };
